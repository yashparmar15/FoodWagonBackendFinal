...
class FoodwagonBackendTrucks(models.Model):
    model_name = models.CharField(db_column='Model_Name', max_length=50)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'foodwagon_backend_trucks'


class FoodwagonBackendVenues(models.Model):
    venue_name = models.CharField(db_column='Venue_Name', max_length=50)  # Field name made lowercase.
    maximum_guest = models.IntegerField(db_column='Maximum_Guest')  # Field name made lowercase.
    price_per_day = models.IntegerField(db_column='Price_per_Day')  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'foodwagon_backend_venues'
